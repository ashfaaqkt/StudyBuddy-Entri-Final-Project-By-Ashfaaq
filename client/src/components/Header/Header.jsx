...
import { HiOutlineBookOpen, HiChartPie, HiOutlineViewGrid, HiOutlinePencilAlt, HiMenu, HiX, HiOutlineLogout } from 'react-icons/hi';
                ...
                <div className="sb-nav w-full px-4 md:px-8 py-3 flex flex-col md:flex-row md:items-center gap-4">
                    ...
                    <div className="hidden md:flex items-center gap-2">
                        {user ? (
                            ...
                            <Link to="/auth" className="sb-btn sb-btn-primary text-xs">Sign In</Link>
                        )}
                    </div>
                    ...
                    <nav className="flex flex-col gap-2">
                        ...
                        {user ? (
                            <button
                                type="button"
                                onClick={handleLogout}
                                className="sb-nav-link text-left"
                            >
                                <HiOutlineLogout className="text-base" />
                                Sign Out
                            </button>
                        ) : (
                            <Link to="/auth" className="sb-nav-link">Sign In</Link>
                        )}
                    </nav>
                </div>
            </div>
