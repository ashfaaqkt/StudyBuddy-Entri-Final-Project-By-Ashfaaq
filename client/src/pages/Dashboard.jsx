...
const Dashboard = () => {
    const { notes, notesLoading, deleteNote, fetchNotes, quizScores } = useAppContext();
    ...
    useEffect(() => {
        const debounce = setTimeout(() => fetchNotes(searchTerm), 300);
                    ...
                    <div className="sb-card sb-notes-collection">
                        ...
                        {notesLoading ? (
                            <div className="sb-notes-empty text-center space-y-3">
                                <div className="w-8 h-8 mx-auto rounded-full border-2 border-emerald-400/40 border-t-transparent animate-spin" />
